...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , underflow{vlSymsp->TOP.underflow}
    , invalid{vlSymsp->TOP.invalid}
    , div_zero{vlSymsp->TOP.div_zero}
    , inexact{vlSymsp->TOP.inexact}
    , fp_operand_a{vlSymsp->TOP.fp_operand_a}
    , fp_operand_b{vlSymsp->TOP.fp_operand_b}
    , fp_operand_c{vlSymsp->TOP.fp_operand_c}
    , fp_f_ab{vlSymsp->TOP.fp_f_ab}
    , rootp{&(vlSymsp->TOP)}
{
