...
void monitor_proc(Vtop *dut) {
    ...
    switch(dut->rmode){
      case 0:
        printf("rmode  = round to nearest tie to even");
        break;
      case 1:
        printf("rmode  = round to zero");
        break;
      case 2:
        printf("rmode  = round down");
        break;
      case 3:
        printf("rmode  = round up");
        break;
      case 4:
        printf("rmode  = round to nearest tie to max magnitude");
        break;
    }
    printf("\ngrs    = %03b\n", dut->grs);
    printf("data   = %.40f", f(dut->data_i));
}
